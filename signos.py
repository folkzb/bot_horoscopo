...
def ariesdef(mensagem):
    ...
    messageText = f'{today} -' + aries[0]['descricao']
...
def escorpiaodef(mensagem):
    ...
    messageText = f'{today} -' + escorpiao[0]['descricao']
    bot.send_message(mensagem.chat.id, messageText)
...
def sagitariodef(mensagem):
    ...
    messageText = f'{today} -' + sagitario[0]['descricao']
    bot.send_message(mensagem.chat.id, messageText)
